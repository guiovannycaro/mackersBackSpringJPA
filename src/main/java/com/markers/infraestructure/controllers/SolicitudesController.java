...
@RestController
@RequestMapping("api/markers/AppAdmin/Solicitudes")
public class SolicitudesController {
	 ...
	 SolicitudesService service;
	  ...
	  @GetMapping(value = "/listarSolicitudes", produces = MediaType.APPLICATION_JSON_VALUE)
	    public List<Solicitudes> listaDatos() {
	        try {
	    ...
	    @PostMapping(value = "/crearSolicitudes", consumes = MediaType.APPLICATION_JSON_VALUE)
	    public void crearDatos(@RequestBody Solicitudes datos) {
	        try {

	            System.out.println("viene del front " + datos.getIdSolicitud());
	    ...
	    @PostMapping(value = "/actualizarSolicitudes", produces = MediaType.APPLICATION_JSON_VALUE)
	    public void actualizarDatos(@RequestBody Solicitudes datos) {
	        try {
	    ...
	    public List<Solicitudes> obtenerById(@RequestParam int datos) {
	        try {
